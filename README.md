# Sample GraphQL project with ASP.NET Core and Hot Chocolate

If you want to build it from scratch see: [graphql-workshop](https://github.com/ChilliCream/graphql-workshop)
...
![Database Schema Diagram](https://github.com/ChilliCream/graphql-workshop/raw/master/docs/images/21-conference-planner-db-diagram.png)
